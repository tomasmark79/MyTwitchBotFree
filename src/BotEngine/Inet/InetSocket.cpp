...
Socket::Socket (void)
    : mConnected (false), mInvalid (true), mReadReady (false), mReadyReadyOOB (false),
      mWriteReady (false), mTimedout (false), mSocket (-1), mReceivedBytes (0) {
  // empty
}

Socket::Socket (int sock)
    : mConnected (true), mInvalid (false), mReadReady (false), mReadyReadyOOB (false),
      mWriteReady (false), mTimedout (false), mSocket (sock), mReceivedBytes (0) {
  // empty
}
